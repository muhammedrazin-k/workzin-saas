        ...
        <div className="min-h-screen bg-[#db1a44] relative flex items-center justify-center p-4 overflow-hidden">
            ...
            <div className="w-full max-w-md bg-white rounded-[40px] shadow-2xl p-8 md:p-12 relative z-10 transition-transform duration-500 hover:scale-[1.01]">
                <div className="text-center mb-8">
                    <h1 className="text-[#db1a44] text-3xl font-extrabold mb-2 tracking-tight">Create Account</h1>
                ...
                <div className="mt-8 text-center flex flex-col items-center gap-6">
                    <div className="relative w-full">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-white px-4 text-[10px] items-center text-gray-400 font-black uppercase tracking-[0.2em]">Or Register With</span>
                        </div>
                    </div>
                    ...
                    <p className="text-gray-400 text-[10px] font-black uppercase tracking-[0.2em]">
                        Already Have One?{' '}
                        <Link href="/auth/login" className="text-[#db1a44] hover:underline hover:text-[#b01536]">
                            Log In
                        </Link>
                    </p>
                </div>
